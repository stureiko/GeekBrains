...
try:
    print('Возможно генерация исключения')
except:
    print('Обработка исключения')
else:
    print('Обработка, если исключения не было')
finally:
    print('Выполняется в любом случае в конце блока')

print('\n************ Генерация исключения **********')
try:
    raise Exception('Пояснение по исключению')
except:
    print('Сгенерровали исключение')
